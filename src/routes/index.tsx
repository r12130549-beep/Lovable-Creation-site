        ...
        {showLoginModal && (
          ...
          >
            <motion.div 
              ...
              className="w-full max-w-md bg-[#0A0A0A] border border-white/5 p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-600 to-purple-600" />
              <button onClick={() => setShowLoginModal(false)} className="absolute top-6 right-6 text-white/20 hover:text-white transition-colors">
                <X className="w-6 h-6" />
              </button>

              <div className="text-center mb-10">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-red-600 to-purple-600 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-red-600/20">
                  <User className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-2xl font-black uppercase tracking-tight mb-2">Welcome Back</h3>
                <p className="text-white/40 text-xs font-bold uppercase tracking-widest">Sign in to your account</p>
              </div>

              <button 
                onClick={handleGoogleLogin}
                className="w-full bg-white text-black hover:bg-white/90 px-8 py-5 rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 transition-all active:scale-95 shadow-xl shadow-white/5"
              >
              ...
              <p className="mt-8 text-center text-[10px] font-bold text-white/20 uppercase tracking-widest leading-relaxed">
                ...
                <span className="text-white/40 hover:text-white cursor-pointer transition-colors underline underline-offset-4">Terms of Service</span> and <span className="text-white/40 hover:text-white cursor-pointer transition-colors underline underline-offset-4">Privacy Policy</span>
              </p>
            </motion.div>
          </motion.div>
        )}
